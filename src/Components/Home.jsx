      ...
      <div className="row ">
        <div className="col-lg-6 slider-content ">
          <div className="slider-sec ">
            <h4 className="sub-title">Welcome to Institute of Medical Coding
            </h4>
        ...
        <div className="col-lg-6 ">
          <div className=" slider-course-sec">
            ...
            <img
              className="slider_pic_1 d-none d-sm-block mt-5 img-fluid"
              // src={slider_1}
              src={teacher1}
              alt="Slider"
            />
              ...
              <div className="col-lg-6">
                <div className="home-about">
                  ...
                  <ul>
                    <li>
                      <p>
                        <strong> <i>Expert Faculty:</i></strong> Our instructors are industry experts with years of practical
                    ...
                    <li>
                      <p>
                        <strong> <i> Practical Curriculum:</i></strong>Our curriculum emphasizes hands-on learning and realworld application. We want you to be not just exam-ready but workplaceready
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong> <i> Certification Focus:</i></strong> Our programs are designed to prepare you for industryrecognized certifications like the Certified Professional Coder (CPC) and
                        Certified Coding Specialist (CCS), boosting your career prospects.
                      </p>
                    </li>
                    <li>
                      <p>
                        <strong><i> Flexible Learning Options:</i></strong> Whether you prefer in-person classes in our modern
                        facilities or the flexibility of online learning, we offer options tailored to your
                        needs
                      </p>
                    </li>
                    <li>
                      <p><strong><i> Career Support: </i></strong> We're more than just an educational institution; we're your
                  ...
                  <div className="col-md-6 mb-3">
                    <div className="single-testimonial">
                      ...
                      <div className="testimonial-content">
                        ...
                        <h4 className="name">John Alexander</h4>
