                ...
                <div class="row justify-content-center">
                  ...
                  <div class="col-lg-4">
                    <div class="about-item">
                      ...
                      <p style={{ fontSize: 16 }}>
                        ...
                        reflected in the dedication to your growth and the excellence of your education.
                      </p>
                    </div>
                  </div>
                  <div class="col-lg-4">
                  ...
                  <div class="col-lg-4">
                    <div class="about-item">
                      ...
                      <p className="" style={{ fontSize: 16 }}>
                        We understand the importance of recognized certifications in advancing your
                        career. Our programs are strategically designed to equip you with the knowledge
                        and skills needed to excel in certification exams. Whether it's the Certified
